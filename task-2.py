...
class Textil:
    ...
    def get_sq_full(self):
        return str(f'Расход ткани общий \n'
                  f' {(self.width / 6.5 + 0.5) + (self.height * 2 + 0.3)} метров')
...
class Coat(Textil):
    ...
    def __str__(self):
        return f'Расход ткани на пальто {self.square_c} метров'
...
class Jacket(Textil):
    ...
    def __str__(self):
        return f'Расход ткани на костюм {self.square_j} метров'

coat = Coat(48, 1.67)
jacket = Jacket(48, 1.67)
print(coat)
print(jacket)
